#include <Servo.h>
int serialVal = 0; // TODO change 0 value in processing
int motorCtrlSpd = 7.96; // TODO Get rid off add map function as replacement

Servo gripper; // TODO Change name and add for new tools
int depthSensor = A0;
int depthValue = 0;
...
void loop() {
  Serial.println(myDirPins.motor1DIR);
}
